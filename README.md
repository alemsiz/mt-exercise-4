...
First, select the correct model configuration file from `mt-exercise-4/configs` and update `model_name` in `scripts/train.sh` accordingly. Then, to train the specified model, run:
